...
//{
//    [SqlTable("tbl_sso")]
//    public class ModTableSSOUser_sqlite : IDBObjectBase
//    {
...
//        public ModTableSSOUser_sqlite() { 
//            LogDate = string.Format("{0:yyyy-MM-dd HH:mm:ss}", DateTime.Now);
//        }

//        public ModTableSSOUser_sqlite(string username)
//        {
//            UserName = username;
//            LogDate = string.Format("{0:yyyy-MM-dd HH:mm:ss}", DateTime.Now);
//        }
...
//        public ModTableSSOUser_sqlite(string username, string etkiv, string encryptedRefreshToken, DateTime refreshTokenExpireDate)
//        {
//            UserName = username;
//            ETKiv = etkiv;
